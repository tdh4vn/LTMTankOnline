...
import majoolwip.core.components.Physics;
...
public class GameContainer implements Runnable
{
	...
	private String title = "Tank Online - LTM";
	...
	public void start()
	{
		...
		physics = new Physics();
		window.setCloseWindowListener(this.closeWindowListener);
	...
	public void setOnWindowCloseListener(Window.CloseWindowListener closeListener){
		this.closeWindowListener = closeListener;
	}
