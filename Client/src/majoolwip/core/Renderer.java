...
import majoolwip.core.fx.Font;
import majoolwip.core.fx.Image;
import majoolwip.core.fx.ImageTile;
import majoolwip.core.fx.Light;
import majoolwip.core.fx.LightRequest;
import majoolwip.core.fx.Pixel;
import majoolwip.core.fx.ShadowType;
...
public class Renderer
{
	...
	public void drawImage(Image image, int offX, int offY)
	{
		for (int x = 0; x < image.width; x++)
		{
			...
			{
				setPixel(x + offX - (int)(image.getWidth() * image.anchorX), y + offY - (int)(image.getHeight() * image.anchorY), image.pixels[x + y * image.width], image.shadowType);
			}
		}
	}
